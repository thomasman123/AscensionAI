      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-16">
        <div className="max-w-md">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-semibold text-tier-50 mb-4">Transform Your Marketing</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-purple-600/20 rounded-full flex items-center justify-center mt-0.5">
                    <CheckCircle size={12} className="text-purple-400" />
                  </div>
                  <div>
                    <p className="text-tier-200 font-medium">AI-Powered Funnels</p>
                    <p className="text-tier-400 text-sm">Generate complete marketing funnels in seconds</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-purple-600/20 rounded-full flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="text-tier-200 font-medium">Automated Campaigns</p>
                    <p className="text-tier-400 text-sm">Smart ad copy and targeting for maximum ROI</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-purple-600/20 rounded-full flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="text-tier-200 font-medium">Real-Time Analytics</p>
                    <p className="text-tier-400 text-sm">Track and optimize performance automatically</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <div className="text-tier-400 text-sm">Funnels Created</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-purple-400">98%</div>
                <div className="text-tier-400 text-sm">Success Rate</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-tier-50 mb-3">Create your account</h2>
            <p className="text-tier-300">Start building AI-powered marketing funnels today</p>
          </div>
